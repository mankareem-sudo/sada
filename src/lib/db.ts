...
function createTableHandler(tableName: string): any {
  return {
    ...
    async create(args: CreateArgs) {
      ...
      const tablesWithoutUpdatedAt = ['Session', 'Follow', 'Like', 'Comment', 'Bookmark', 'Report', 'Notification', 'SupportDonation', 'Post', 'PostLike', 'PostComment', 'Friendship', 'Message', 'Block', 'VoiceStory', 'VoiceStoryView']
